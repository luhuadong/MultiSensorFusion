...
if __name__ == "__main__":
    ...
    if ret == 0:
        ...
        print("35127316:%d",stConvertParam.enPixelType)
        ...
        ctypes.memmove(byref(img_buff), stConvertParam.pImageBuffer, stConvertParam.nImageLen)
